        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReservationDateUtc = table.Column<DateTime>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LinkedSportIds = table.Column<string>(type: "TEXT", nullable: false),
                    CreatedAtUtc = table.Column<DateTime>(type: "TEXT", nullable: false),
                    UpdatedAtUtc = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ticket_bookings", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Price = table.Column<decimal>(type: "TEXT", nullable: false),
                    AvailableSinceUtc = table.Column<DateTime>(type: "TEXT", nullable: false),
                    AvailableUntilUtc = table.Column<DateTime>(type: "TEXT", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "TEXT", nullable: false),
                    CreatedAtUtc = table.Column<DateTime>(type: "TEXT", nullable: false),
                    UpdatedAtUtc = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_reservations_SportId_ReservationDateUtc_TimeSlot",
                table: "reservations",
                columns: new[] { "SportId", "ReservationDateUtc", "TimeSlot" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ticket_bookings_TicketId_UserId",
                table: "ticket_bookings",
                columns: new[] { "TicketId", "UserId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_tickets_AvailableSinceUtc",
                table: "tickets",
                column: "AvailableSinceUtc");

            migrationBuilder.CreateIndex(
                name: "IX_tickets_AvailableUntilUtc",
                table: "tickets",
                column: "AvailableUntilUtc");
        }
